  ...
  return (
    <DashboardLayout currentPage="/mensajes">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground font-body">
              Comunicación entre consultores y clientes
            </p>
          </div>
          <Button
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  Recibidos
                  {mensajesNoLeidos > 0 && (
                    <Badge className="ml-2 bg-warning text-warning-foreground">{mensajesNoLeidos}</Badge>
                  )}
                </Button>
                <Button
                ...
                {displayMensajes.map((mensaje) => (
                  <div
                    ...
                    className={`border rounded-lg p-4 hover:border-primary transition-colors cursor-pointer hover-scale animate-fade-in ${
                      !mensaje.leido && mensaje.destinatario_id === user?.id
      ...
      <CreateMensajeDialog
        ...
        onMensajeCreated={fetchMensajes}
      />
