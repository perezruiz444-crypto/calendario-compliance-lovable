-- ============================================================
-- PARCHES DE SEGURIDAD UNIFICADOS (IDEMPOTENTE Y SEGURO)
-- Proyecto Supabase: svozqrjhwaohfmbkhpig
-- Pega TODO este contenido en el SQL Editor de Supabase y presiona RUN.
...
DROP POLICY IF EXISTS "agentes_aduanales_select_scoped" ON public.agentes_aduanales;
...
-- ============================================================
-- BATCH 2: RLS obligaciones / storage task-attachments
-- ============================================================

DROP POLICY IF EXISTS "Admins and consultores can insert obligaciones" ON public.obligaciones;
DROP POLICY IF EXISTS "obligaciones_insert_scoped" ON public.obligaciones;
...
DROP POLICY IF EXISTS "obligaciones_update_scoped" ON public.obligaciones;
...
-- ============================================================
-- BATCH 3: RLS obligacion_cumplimientos / obligacion_responsables
-- ============================================================
...
DROP POLICY IF EXISTS "obligacion_responsables_select_scoped" ON public.obligacion_responsables;
...
-- ============================================================
-- BATCH 4: Realtime messages (protegido contra restricciones de ownership)
-- ============================================================
...
EXCEPTION
  WHEN OTHERS THEN
    RAISE NOTICE 'Nota: realtime.messages es administrado internamente por el sistema Supabase';
END $$;
